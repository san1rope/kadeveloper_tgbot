...
from .payment_confirmation import router as r_payment_confirmation

routers = [r_start, r_how_to_start, r_order_feedbacks, r_active_orders, r_ask_question, r_payment_confirmation]
